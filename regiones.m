...
% - Imágen a subdividir M
% - M2 es la imágen de la que posteriormente se extraeran los pixeles de las regiones,
% por si M ~= M2 (tanto M como M2 deben tener las mismas dimensiones)
...
% - Un array de celdas (rx2) donde r es el número de regiones en las que se ha dividido la
...
% La segunda columna es una matriz con los pixeles de la región.
